      ...
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-8 md:mb-0">
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              Empowering farmers with AI-powered insights for better farming and fair market access.
            </p>
          </div>
          ...
          <div className="w-full md:w-2/3 grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul role="list" className="mt-4 space-y-4">
                <li>
                  <a href="#" className="text-base text-gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-primary">
                    For Farmers
                  </a>
                </li>
                <li>
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-500 dark:text-gray-400 md:mt-0 md:order-1">
            &copy; 2023 AgroLynk, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
